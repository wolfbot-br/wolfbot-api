...
<<<<<<< HEAD:src/api/services/backtest/backtest.service.js
    const errors = [];
...
const post = (req, res, next) => {
    let ex = {
        ...
        strategy: {
            ...
            indicators: {
                ema: {
                    status: req.body.strategy.indicators.ema.status || false,
                    period: req.body.strategy.indicators.ema.period || 9,
                },
                macd: {
    ...
    const nova_configuracao = new backtestConfiguration({
...
>>>>>>> master:src/api/backtest/backtest.service.js
